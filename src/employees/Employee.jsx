...
import { fnGetData,fnCreateData,fnUpateData,fnGetDirectData,fnHasPermission } from '../shared/shared';
    ...
    Object.assign(
      ...
      render: (record) => (
        ...
        <Tooltip title="Delete">
            <Button type="primary" onClick={() => fnDeleteSkill(record)} icon={<DeleteOutlined/>} style={{backgroundColor: '#fc4949', marginLeft: 8}} disabled={!fnHasPermission(9,3)}/>
        </Tooltip>
        </>
      ),
    },
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={12}>
                        <div className="form-group">
                          ...
                          <Row>
                            ...
                            <Form.Item name="password"  rules={[{ required: JSON.stringify(employee) === "{}" ? true : false, message: 'Please input your password!' }]} >
                      ...
                      <Col span={12}>
                        ...
                        <Col span={8} style={{ textAlign: 'left' }}>
                          <Button onClick={fnAddSkill} disabled={!fnHasPermission(9,3)}>
                            Add skill
                          </Button>
                        </Col>
                        ...
                        <div className="form-actions">
                          {
                            JSON.stringify(employee) === "{}"? (
                              ...
                              <button type="submit" className="btn btn-primary" disabled={!fnHasPermission(9,3)}>
                                  Save Employee
                              </button>
                            )
                          }
