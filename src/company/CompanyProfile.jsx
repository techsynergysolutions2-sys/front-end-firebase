...
import {fnGetData,fnUpateData,fnGetDirectData,url,amou,fnFileURls,fnCheckExpiryDate,fnHasPermission} from '../shared/shared'
                        ...
                        <div className="row g-3">
                          <div className="col-12">
                            <Row>
                              ...
                              <Col span={3}>
                                <Button type="primary" onClick={() => showModal()} style={{backgroundColor: '#1092a7', color: '#fff', marginTop: 34}} disabled={!fnHasPermission(14,3)}>
                                  Add space
                                </Button>
                              </Col>
                            </Row>
